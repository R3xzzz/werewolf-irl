...
export const ROLES: Record<string, RoleDefinition> = {
  ...
  pacifist: {
    ...
    team: 'village',
    description: 'Once per game at the start of the day, you can call for peace. If activated, no one will be eliminated today and voting will be skipped.',
    desc_id: 'Sekali dalam game saat siang dimulai, kamu bisa menyerukan perdamaian. Jika aktif, tidak ada yang dieliminasi hari ini dan voting dilewati.',
    hasNightAction: false,
  },
  diseased: {
    id: 'diseased',
  ...
  troublemaker: {
    ...
    team: 'village',
    description: 'Each night while alive, you may choose to stir up trouble. If used, you select 2 players. Next day\'s vote will be restricted ONLY to those two players. (Once per match)',
    desc_id: 'Setiap malam saat hidup, kamu bisa memilih untuk berbuat onar. Jika digunakan, pilih 2 pemain. Voting hari esok akan terbatas HANYA pada kedua pemain tersebut. (Sekali per match)',
    nightActionPriority: 40,
    hasNightAction: true,
  },
  cupid: {
    id: 'cupid',
